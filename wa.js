...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  :root{
    --bg-1:#eef2f8;--bg-2:#e4ebf5;--paper:rgba(255,255,255,.92);--paper-strong:rgba(255,255,255,.98);--paper-soft:rgba(255,255,255,.7);
    --line:rgba(20,33,58,.08);--line-strong:rgba(20,33,58,.14);--text:#151c2c;--muted:#697489;
    --green:#0c8f5e;--green-soft:rgba(12,143,94,.12);--red:#c8384f;--red-soft:rgba(200,56,79,.12);
    --blue:#2952d1;--blue-soft:rgba(41,82,209,.1);--amber:#b3720b;--amber-soft:rgba(179,114,11,.14);
    --teal:#0b7d8c;--pink:#b8447e;--ink:#0f1830;--accent:#2952d1;--accent-2:#0c8f5e;
    --shadow:0 18px 46px rgba(20,33,58,.09);--shadow-lg:0 28px 64px rgba(15,24,48,.14);--radius:18px;--radius-sm:12px;
    --side-bg:linear-gradient(180deg,#0f1830 0%,#141d38 60%,#111a33 100%);--side-line:rgba(255,255,255,.09);--side-text:#c7cfe4;
  }
  html[data-theme="dark"]{
    --bg-1:#0b1120;--bg-2:#0e1526;--paper:rgba(24,31,49,.86);--paper-strong:rgba(28,36,56,.94);--paper-soft:rgba(24,31,49,.6);
    --line:rgba(255,255,255,.08);--line-strong:rgba(255,255,255,.14);--text:#e9edf7;--muted:#93a0bb;
    --green:#33c98c;--green-soft:rgba(51,201,140,.14);--red:#ff6b81;--red-soft:rgba(255,107,129,.14);
    --blue:#6f93ff;--blue-soft:rgba(111,147,255,.16);--amber:#f0b545;--amber-soft:rgba(240,181,69,.16);
    --shadow:0 18px 46px rgba(0,0,0,.35);--shadow-lg:0 28px 70px rgba(0,0,0,.45);
    --side-bg:linear-gradient(180deg,#080c18 0%,#0b1224 100%);--side-line:rgba(255,255,255,.07);--side-text:#aeb9d3;
  }
  html{background:var(--bg-1)}
  body{font-family:'Inter','Plus Jakarta Sans','Segoe UI',ui-sans-serif,system-ui,sans-serif;color:var(--text);min-height:100vh;letter-spacing:-.01em;background:linear-gradient(160deg,var(--bg-1),var(--bg-2));background-attachment:fixed;transition:background .25s ease,color .25s ease}
  body:before{content:"";position:fixed;inset:0;pointer-events:none;background:radial-gradient(1100px 520px at 12% -6%,rgba(41,82,209,.08),transparent 60%),radial-gradient(900px 480px at 100% 0%,rgba(12,143,94,.06),transparent 55%);z-index:0}
  button,input,select{font:inherit}button{color:inherit}[hidden]{display:none!important}
  ::-webkit-scrollbar{width:9px;height:9px}::-webkit-scrollbar-thumb{background:rgba(120,135,165,.35);border-radius:99px}::-webkit-scrollbar-track{background:transparent}
  ...
  .mark{width:38px;height:38px;border-radius:11px;background:linear-gradient(135deg,var(--accent),var(--accent-2));color:white;display:grid;place-items:center;font-weight:800;font-size:.82rem;box-shadow:0 10px 22px rgba(41,82,209,.35);letter-spacing:0}
  ...
  .nav-item:hover{background:rgba(255,255,255,.06);color:#fff}.nav-item.active{background:linear-gradient(135deg,rgba(111,147,255,.22),rgba(51,201,140,.14));color:#fff;font-weight:800;box-shadow:inset 0 0 0 1px rgba(255,255,255,.12)}
  ...
  .btn{border:1px solid var(--line-strong);background:var(--paper-strong);color:var(--text);border-radius:11px;padding:8px 13px;cursor:pointer;font-weight:700;font-size:.85rem;transition:background .15s ease,border-color .15s ease,box-shadow .15s ease,transform .1s ease}
  .btn:hover{border-color:var(--accent);box-shadow:0 8px 20px rgba(41,82,209,.14);transform:translateY(-1px)}.btn.primary{background:linear-gradient(135deg,var(--accent),#3f6bea);border-color:transparent;color:white}.btn.primary:hover{filter:brightness(1.06)}.btn.danger{background:var(--red-soft);color:var(--red);border-color:transparent}.btn.small{padding:6px 9px;font-size:.74rem;border-radius:8px}
  .icon-btn{position:relative;width:38px;height:38px;padding:0;display:grid;place-items:center;border-radius:11px}
  .badge-count{position:absolute;top:-4px;right:-4px;background:var(--red);color:#fff;font-size:.62rem;font-weight:800;min-width:16px;height:16px;border-radius:99px;display:grid;place-items:center;padding:0 3px}
  .pill{display:inline-flex;align-items:center;gap:8px;border:1px solid var(--line);background:var(--paper-strong);border-radius:999px;padding:8px 12px;font-size:.8rem;font-weight:750}.dot{width:8px;height:8px;border-radius:99px;background:var(--amber)}.dot.online{background:var(--green);box-shadow:0 0 0 3px var(--green-soft)}.dot.offline{background:var(--red);box-shadow:0 0 0 3px var(--red-soft)}
  ...
  .metric-card,.panel-card,.mini,.radar-card{background:var(--paper);border:1px solid var(--line);border-radius:var(--radius);box-shadow:var(--shadow)}
  .metric-card{padding:16px;min-height:118px;display:grid;align-content:space-between;gap:8px;position:relative;overflow:hidden;border-top:2px solid transparent}
  ...
  .finance-hero{position:relative;overflow:hidden;background:linear-gradient(120deg,#101a35,#152a4d 55%,#0f2338);color:#f4f8ff;border:1px solid rgba(255,255,255,.1);border-radius:22px;padding:24px;display:grid;grid-template-columns:minmax(0,1.28fr) repeat(3,minmax(135px,.5fr));gap:14px;align-items:center;box-shadow:var(--shadow-lg)}
  .finance-hero:before{content:"";position:absolute;inset:0;background:radial-gradient(600px 260px at 90% -20%,rgba(111,147,255,.28),transparent 60%);pointer-events:none}.hero-copy,.hero-stat{position:relative}.hero-copy h3{font-size:1.2rem;font-weight:800}.hero-copy p{color:#aebbe0;font-size:.85rem;margin-top:6px;max-width:620px}.hero-stat{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);border-radius:15px;padding:13px}.hero-stat span{display:block;color:#9aa8cc;font-size:.72rem;font-weight:600}.hero-stat b{display:block;font-size:1.08rem;margin-top:5px;font-weight:800}.score{color:#4fdba0}
  ...
  @media (max-width:720px){.shell{display:block;padding:12px}.sidebar{display:none;position:fixed;z-index:25;inset:12px;height:auto;overflow:auto}.shell.menu-open .sidebar{display:flex}.mobile-overlay{position:fixed;inset:0;background:rgba(13,31,50,.42);z-index:24;backdrop-filter:blur(8px)}.shell.menu-open .mobile-overlay{display:block}.content{gap:14px;padding-bottom:78px}.nav{grid-template-columns:repeat(2,minmax(0,1fr))}.metric-grid,.mini-grid,.budget-summary,.trend-kpis,.smart-radar,.binance-kpis{grid-template-columns:1fr}.metric-card .value{font-size:1.05rem;word-break:normal}.status-grid,.form-grid,.finance-hero{grid-template-columns:1fr}.hero-stat{padding:12px}.form-group.full{grid-column:auto}.toolbar,.catalog-toolbar{align-items:stretch}.field,.search-field,.btn{width:100%}.table-wrap{max-height:420px}.chart-wrap{height:300px}.report-banner{align-items:flex-start;flex-direction:column}.report-balance{text-align:left}.topbar{padding:14px}.bottom-nav{display:flex}.menu-fab{display:none}}
  ...
  .bottom-nav .bn-item{flex:1;display:flex;flex-direction:column;align-items:center;gap:2px;background:transparent;border:0;color:var(--side-text);padding:7px 2px;border-radius:12px;font-size:.62rem;font-weight:800;cursor:pointer}
  .bottom-nav .bn-item .bn-ic{font-size:1.05rem;line-height:1}
  .bottom-nav .bn-item.active{color:#fff;background:linear-gradient(135deg,rgba(111,147,255,.28),rgba(51,201,140,.18))}

  /* ============================================================
     LAPORAN VISUAL — themed "buku kas" ledger page (signature view)
  ============================================================ */
  .lv-wrap{--lv-ink:#16261F;--lv-paper:#F1E9D8;--lv-paper2:#E8DEC7;--lv-card:#FBF7EC;--lv-gold:#B8862F;--lv-golddeep:#8C6A22;--lv-jade:#2F6F4E;--lv-jadedeep:#1F4C36;--lv-rust:#9C3B34;--lv-line:rgba(22,38,31,.16);
    display:grid;gap:20px;color:var(--lv-ink);font-family:Georgia,'Iowan Old Style','Times New Roman',serif}
  .lv-mono{font-family:ui-monospace,'SF Mono','Cascadia Mono','JetBrains Mono',Consolas,monospace;font-style:normal}
  .lv-cover{background:linear-gradient(165deg,var(--lv-jadedeep) 0%,var(--lv-ink) 100%);color:var(--lv-paper);padding:30px 28px;border-radius:20px;position:relative;overflow:hidden;box-shadow:var(--shadow-lg)}
  .lv-cover:before{content:"";position:absolute;inset:0;background-image:repeating-linear-gradient(0deg,rgba(241,233,216,.035) 0,rgba(241,233,216,.035) 1px,transparent 1px,transparent 30px);pointer-events:none}
  .lv-eyebrow{text-transform:uppercase;letter-spacing:.22em;font-size:11px;color:#D9C68F;display:flex;align-items:center;gap:10px;font-family:-apple-system,sans-serif;font-weight:700}
  .lv-eyebrow:before{content:"";width:20px;height:1px;background:#D9C68F;display:inline-block}
  .lv-cover h2{font-weight:400;font-size:clamp(22px,4vw,32px);margin:10px 0 4px;letter-spacing:.01em}
  .lv-cover .lv-sub{color:#C9CFC5;font-size:13px;font-family:-apple-system,sans-serif;margin-bottom:18px}
  .lv-hero-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;position:relative}
  .lv-hero-stat{background:rgba(241,233,216,.07);border:1px solid rgba(241,233,216,.16);border-radius:12px;padding:13px 15px}
  .lv-hero-stat .lv-lbl{font-size:10px;text-transform:uppercase;letter-spacing:.1em;color:#B9C3B7;font-family:-apple-system,sans-serif;font-weight:700}
  .lv-hero-stat .lv-val{font-size:19px;margin-top:6px}
  .lv-hero-stat.income .lv-val{color:#8FD9A8}.lv-hero-stat.expense .lv-val{color:#E5A79E}.lv-hero-stat.net .lv-val{color:#E8CE86}
  .lv-page{background:var(--lv-card);border:1px solid var(--lv-line);border-radius:18px;padding:24px 26px;position:relative;box-shadow:var(--shadow)}
  .lv-tag{position:absolute;top:-12px;left:24px;background:var(--lv-gold);color:#fff;font-size:10px;letter-spacing:.1em;text-transform:uppercase;padding:4px 12px;border-radius:20px;font-family:-apple-system,sans-serif;font-weight:700;box-shadow:0 4px 10px rgba(140,106,34,.35)}
  .lv-title{font-weight:400;font-size:20px;margin:2px 0 4px;color:var(--lv-jadedeep)}
  .lv-desc{font-family:-apple-system,sans-serif;color:#4b5a51;font-size:13px;margin-bottom:18px;max-width:640px}
  ...
  .lv-legend li{display:flex;justify-content:space-between;align-items:center;padding:8px 0;border-bottom:1px solid var(--lv-line);font-size:12.5px}
  ...
  .lv-amt{font-weight:700}.lv-pct{color:#6d7b71;font-size:10.5px;margin-left:5px}
  .lv-chip-row{display:flex;flex-wrap:wrap;gap:9px;font-family:-apple-system,sans-serif}
  .lv-chip{background:#fff;border:1px solid var(--lv-line);border-radius:30px;padding:7px 13px;font-size:12.5px;display:flex;gap:7px;align-items:baseline}
  .lv-chip b{color:var(--lv-rust)}.lv-chip span{font-size:10px;color:#6d7b71}
  .lv-receipt-shell{display:flex;justify-content:center;padding:6px 0}
  .lv-receipt{width:100%;max-width:420px;background:#FDFBF4;color:#24322A;padding:22px 20px 16px;border-radius:2px;box-shadow:0 14px 30px rgba(22,38,31,.22);position:relative;transform:rotate(-.6deg);font-family:-apple-system,sans-serif}
  .lv-receipt:before,.lv-receipt:after{content:"";position:absolute;left:0;right:0;height:12px;background:repeating-radial-gradient(circle at 8px 6px,transparent 0 6px,var(--lv-paper) 6px 12px);background-size:16px 12px}
  .lv-receipt:before{top:-6px}.lv-receipt:after{bottom:-6px}
  .lv-receipt h4{text-align:center;letter-spacing:.08em;font-size:12.5px;text-transform:uppercase;margin:0 0 2px;font-family:ui-monospace,monospace}
  .lv-rsub{text-align:center;font-size:10.5px;color:#71806f;margin-bottom:12px}
  .lv-rrow{display:flex;justify-content:space-between;gap:10px;font-family:ui-monospace,monospace;font-size:11.5px;padding:6px 0;border-bottom:1px dotted #C9C0A6}
  .lv-rrow .lv-rname{max-width:230px}.lv-rrow .lv-rcat{display:block;font-size:9px;color:#8a9186;text-transform:uppercase;letter-spacing:.05em;margin-top:2px}
  .lv-rrow .lv-ramt{font-weight:700;white-space:nowrap}
  .lv-rtotal{display:flex;justify-content:space-between;margin-top:12px;padding-top:10px;border-top:1px solid #24322A;font-family:ui-monospace,monospace;font-weight:700;font-size:12.5px}
  .lv-barcode{margin-top:14px;height:28px;background:repeating-linear-gradient(90deg,#24322A 0 2px,transparent 2px 4px,#24322A 4px 5px,transparent 5px 8px);opacity:.75}
  .lv-insight-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;font-family:-apple-system,sans-serif}
  .lv-insight-card{background:var(--lv-paper2);border-radius:14px;padding:16px;border:1px solid var(--lv-line)}
  .lv-insight-card .lv-big{font-family:ui-monospace,monospace;font-size:20px;font-weight:700;color:var(--lv-jadedeep)}
  .lv-insight-card .lv-lbl2{font-size:11.5px;color:#4b5a51;margin-top:4px}
  .lv-rec-list{margin:0;padding-left:18px;font-family:-apple-system,sans-serif}
  .lv-rec-list li{margin-bottom:9px;font-size:13px;color:var(--lv-ink)}
  .lv-rec-list b{color:var(--lv-jadedeep)}
  .lv-stamp{display:inline-block;border:2.5px solid var(--lv-rust);color:var(--lv-rust);padding:7px 15px;border-radius:8px;transform:rotate(-4deg);font-family:-apple-system,sans-serif;font-weight:800;text-transform:uppercase;letter-spacing:.07em;font-size:11.5px;opacity:.85}
  @media(max-width:760px){.lv-two-col{grid-template-columns:1fr}.lv-hero-grid,.lv-insight-grid{grid-template-columns:1fr}}
</style>
</head>
<body>
  ...
  <main class="content">
    ...
    <section class="view active" data-view="overview" id="view-overview">
      ...
      <div class="metric-grid">
        <div class="metric-card"><div class="label">Pemasukan Periode</div><div class="value green" id="income-month">-</div><div class="hint" id="income-today">-</div><canvas class="spark" id="spark-income"></canvas></div>
        <div class="metric-card"><div class="label">Pengeluaran Periode</div><div class="value red" id="expense-month">-</div><div class="hint" id="expense-today">-</div><canvas class="spark" id="spark-expense"></canvas></div>
    ...
    <section class="view" data-view="laporanvisual" id="view-laporanvisual">
      <div class="lv-wrap">
        <div class="lv-cover tilt">
          ...
          <button type="button" id="lv-period-shortcut" style="font-family:-apple-system,sans-serif;font-size:11.5px;font-weight:700;background:rgba(241,233,216,.12);border:1px solid rgba(241,233,216,.3);color:#E8CE86;padding:6px 13px;border-radius:20px;cursor:pointer;margin-bottom:16px">🔄 Ganti periode / bulan</button>
        ...
        <div class="lv-page tilt">
          ...
          <hr style="border:none;border-top:1px dashed var(--lv-line);margin:20px 0">
...
<script>
  ...
  function drawSparklines(rows) {
    ...
    draw("spark-income", "masuk", "#0c8f5e");
    draw("spark-expense", "keluar", "#c8384f");
  }
  ...
  function drawLvDailyChart(trend) {
    ...
    if (!trend || !trend.length) {
      svg.innerHTML = '<text x="' + (W/2) + '" y="' + (H/2) + '" text-anchor="middle" fill="#8a9186" font-size="14" font-family="-apple-system,sans-serif">Belum ada data tren pada periode ini</text>';
      return;
    }
    ...
    trend.forEach((r, i) => {
      ...
      if (h > 0.5) bars += '<rect x="' + x.toFixed(1) + '" y="' + y.toFixed(1) + '" width="' + bw.toFixed(1) + '" height="' + h.toFixed(1) + '" rx="2.5" fill="rgba(47,111,78,.55)"></rect>';
    });
    ...
    const gridLines = [0, 0.25, 0.5, 0.75, 1].map(t => {
      ...
      return '<line x1="' + padL + '" y1="' + y.toFixed(1) + '" x2="' + (W-padR) + '" y2="' + y.toFixed(1) + '" stroke="rgba(22,38,31,.08)" stroke-width="1"></line>' +
             '<text x="' + (padL-8) + '" y="' + (y+3).toFixed(1) + '" text-anchor="end" font-size="10" fill="#6d7b71" font-family="ui-monospace,monospace">' + label + '</text>';
    }).join("");

    const step = Math.max(1, Math.ceil(n / 10));
    const xLabels = trend.map((r, i) => i % step === 0 || i === n-1 ? '<text x="' + xAt(i).toFixed(1) + '" y="' + (H-10) + '" text-anchor="middle" font-size="9.5" fill="#6d7b71" font-family="-apple-system,sans-serif">' + esc(r.label||"") + '</text>' : "").join("");

    const dots = trend.map((r,i) => '<circle cx="' + xAt(i).toFixed(1) + '" cy="' + yAt(keluarVals[i]).toFixed(1) + '" r="2.6" fill="#9C3B34"></circle>').join("");

    svg.innerHTML =
      gridLines +
      bars +
      '<polygon points="' + areaPts + '" fill="rgba(156,59,52,.12)"></polygon>' +
      '<polyline points="' + linePts + '" fill="none" stroke="#9C3B34" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"></polyline>' +
      dots + xLabels +
      '<g font-family="-apple-system,sans-serif" font-size="11" font-weight="700">' +
        '<rect x="' + padL + '" y="0" width="10" height="10" rx="2" fill="rgba(47,111,78,.55)"></rect><text x="' + (padL+16) + '" y="9" fill="#3A4A41">Pemasukan</text>' +
        '<rect x="' + (padL+110) + '" y="0" width="10" height="10" rx="2" fill="#9C3B34"></rect><text x="' + (padL+126) + '" y="9" fill="#3A4A41">Pengeluaran</text>' +
      '</g>';
  }

  function drawLvDonut(cats) {
    const svg = $("lv-cat-chart");
    const total = cats.reduce((a,c) => a + Number(c.amount||0), 0);
    if (!cats.length || total <= 0) {
      svg.innerHTML = '<text x="130" y="130" text-anchor="middle" fill="#8a9186" font-size="13" font-family="-apple-system,sans-serif">Belum ada data</text>';
      return;
    }
    const cx = 130, cy = 130, r = 92, sw = 30;
    ...
    svg.innerHTML = segs +
      '<circle cx="' + cx + '" cy="' + cy + '" r="' + (r - sw/2 - 4) + '" fill="var(--lv-card)"></circle>' +
      '<text x="' + cx + '" y="' + (cy-6) + '" text-anchor="middle" font-family="ui-monospace,monospace" font-size="10" fill="#6d7b71">TOTAL</text>' +
      '<text x="' + cx + '" y="' + (cy+14) + '" text-anchor="middle" font-family="ui-monospace,monospace" font-size="13" font-weight="700" fill="var(--lv-ink)">' + money(total) + '</text>';
  }
  ...
  function renderLaporanVisual(finance, report) {
    ...
    if (kwTotals[0]) notes.push("Kebiasaan paling sering tercatat: <b>" + esc(kwTotals[0].label.replace(/^\S+\s/, "")) + "</b>, total " + money(kwTotals[0].total) + " (" + kwTotals[0].count + "x transaksi).");
  ...
  const lvPeriodShortcut = document.getElementById("lv-period-shortcut");
  if (lvPeriodShortcut) lvPeriodShortcut.addEventListener("click", () => {
    const sel = $("global-period-select");
